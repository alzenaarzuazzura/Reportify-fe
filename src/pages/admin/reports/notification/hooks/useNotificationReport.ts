...
const useNotificationReport = () => {
  ...
  const { data, isLoading, refetch } = useQuery({
    queryKey: ['notificationReport', dateRange, selectedClass, selectedStudent],
    queryFn: () =>
...
export default useNotificationReport;
