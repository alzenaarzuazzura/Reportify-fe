...
const DlgSubject = ({ open, onClose, id, mode = 'create' }: TDlgSubjectProps) => {
	const intl = useIntl()
	...
	const getTitle = () => {
		...
		return intl.formatMessage({ id: 'global.create' }, { thing: intl.formatMessage({ id: 'menu.subjects' })})
	}
